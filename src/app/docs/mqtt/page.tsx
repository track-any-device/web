...
export const metadata: Metadata = { title: 'MQTT Forwarding | Track Any Device' };

/* For Business — receive real-time device updates on your own MQTT broker.
   Content lives in Sanity (docPage slug "mqtt"). */

const SLUG = 'mqtt';

export default async function MqttForwardingDoc() {
